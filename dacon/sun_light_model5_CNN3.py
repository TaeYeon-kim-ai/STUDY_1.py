...
from tensorflow.keras.layers import Dense, LSTM, Input, Dropout, Conv2D, MaxPooling2D, Flatten, concatenate, Reshape
...
def co1_model() :
    ...
    conv2d = Conv2D(256, 3, activation= 'relu', padding= 'SAME',input_shape = (x_train.shape[1], x_train.shape[2]))(inputs)
    conv2d = Conv2D(128, 2, padding= 'SAME', activation='relu')(conv2d)
    conv2d = Conv2D(128, 2, padding= 'SAME', activation='relu')(conv2d)
    flt = Flatten()(conv2d)
    dense1 = Dense(64, activation='relu')(conv2d)
