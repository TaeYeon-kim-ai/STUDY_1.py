...
#2. 모델링
TF = EfficientNetB5(weights= 'imagenet', include_top = False, input_shape = (32, 32, 3)) #레이어 16개
...
model.fit(x_train, y_train, epochs = 10, batch_size = 64, validation_data= (x_val, y_val), verbose = 1 ,callbacks = [es])
