...
#npy 저장하기
np.save('../data/image/brain/npy/keras66_train_x.npy', arr=xy_train[0][0]) #x 1
...
x_test = np.load('../data/image/brain/npy/keras66_train_y.npy')
y_train = np.load('../data/image/brain/npy/keras66_test_x.npy')
