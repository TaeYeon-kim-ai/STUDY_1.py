...
from tensorflow.keras.layers import  Dense, Flatten, Conv2D, Input, MaxPooling2D, LeakyReLU, Softmax, GlobalAvgPool2D, BatchNormalization
...
#.npy Load
x = np.load('C:/data/LPD_competition/npy/LT_x_train_172.npy', allow_pickle=True)
y = np.load('C:/data/LPD_competition/npy/LT_y_train_172.npy', allow_pickle=True)
target = np.load('C:/data/LPD_competition/npy/LT_x_pred_172.npy', allow_pickle=True)
