...
def solution_model():
    ...
    # Model
    model = Sequential()
    model.add(Dense(1, input_dim = 1, kernel_initializer="ones", bias_initializer="ones", activation="linear"))
...
if __name__ == '__main__':
    ...
    model.save("C:\STUDY_1.py/tf_certificate/Category1/mymodel.h5")
