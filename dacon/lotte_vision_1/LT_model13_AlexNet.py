...
x = np.load('../../data/npy/train_x_227.npy', allow_pickle=True)
y = np.load('../../data/npy/train_y_227.npy', allow_pickle=True)
target = np.load('../../data/npy/predict_x_227.npy', allow_pickle=True)
