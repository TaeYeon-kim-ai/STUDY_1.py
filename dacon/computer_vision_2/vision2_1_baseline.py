...
#데이터
dirty_mnist_answer = pd.read_csv("C:/STUDY/dacon/computer_vision_2/dirty_mnist_2nd_answer.csv")
# dirty_mnist라는 디렉터리 속에 들어있는 파일들의 이름을 
# namelist라는 변수에 저장
namelist = os.listdir('C:/STUDY/dacon/computer_vision_2/')
...
for fold_index, (trn_idx, val_idx) in enumerate(kfold.split(dirty_mnist_answer),1):
    ...
    for epoch in range(10):
        ...
        if valid_acc_max < valid_acc:
            ...
            MODEL = "resnet18"
            # 모델을 저장할 구글 드라이브 경로
            path = "C:/STUDY/dacon/computer_vision_2"
...
#앙상블
#test Dataset 정의
sample_submission = pd.read_csv("C:/STUDY/dacon/computer_vision_2/sample_submission.csv")
test_dataset = DatasetMNIST("C:/data/csv/cvision_2/test_dirty_mnist_2nd/", sample_submission)
batch_size = 128
...
predictions_list = []
# 배치 단위로 추론
prediction_df = pd.read_csv("C:/STUDY/dacon/computer_vision_2/sample_submission.csv")
...
sample_submission.to_csv("C:/STUDY/dacon/computer_vision_2/baseline_prediction.csv", index = False)
sample_submission